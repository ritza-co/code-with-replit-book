...
![Creating a new repl](https://i.ritzastatic.com/repl/codewithrepl/21-steganography/01-create-repl.png)
...
![Encoding a message as a binary string](https://i.ritzastatic.com/repl/codewithrepl/21-steganography/02-encode-binstring.png)
...
![Image showing file upload](https://i.ritzastatic.com/repl/codewithrepl/21-steganography/03-upload-file.png)
...
If you have followed along you'll have your own repl to expand; if not you can fork [our repl](https://repl.it/@ritza/python-steganography) and work from there.
